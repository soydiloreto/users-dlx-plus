...
For maintainers. End users get the plugin from [wordpress.org/plugins/users-plus-for-wordpress](https://wordpress.org/plugins/users-plus-for-wordpress/) — they don't need to read this document.

 ...
 */
function upfw_sso_providers(): array {
	$providers = array(
		'google'    => array(
			'name'      => 'Google',
			'color'     => '#EA4335',
	 ...
	 */
	return apply_filters( 'upfw_sso_providers', $providers );
}
